...
@section('content')
    <div class="space-y-6">
        <div class="bg-base-100 shadow-base-300/20 w-full space-y-6 rounded-xl p-6 shadow-md lg:p-8">
            <div>
                <h3 class="text-base-content mb-1.5 text-2xl font-semibold">{{ __('Edit User') }}</h3>
                <p class="text-base-content/80">{{ __('Update user information') }}</p>
            </div>
            ...
            <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="label-text" for="userName">{{ __('Name') }}*</label>
                ...
                <div>
                    <label class="label-text" for="userEmail">{{ __('Email address') }}*</label>
